    ...
    <div class="container">
        ...
        {{-- <ul class="navbar-nav">
            <li class="nav-item dropdown d-flex align-items-center">
                <span class="shadow-sm rounded-circle border border-secondary dropdown-navbar" type="button" data-bs-toggle="dropdown" style="height:43px; width:43px;"></span>
                <ul class="dropdown-menu p-0" style="transform: translate(-138px, 5px); width: 180px;">
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('profile.main') }}">Profile</a>
                    </li>
                    <li>
                        <span class="dropdown-item py-2" href="#">
                        ...
                        <li class="nav-item dropdown d-flex align-items-center">
                            ...
                            <ul class="dropdown-menu border border-1 p-0" style="transform: translate(-138px, 5px); width: 180px;">
                                ...
                                <li>
                                    ...
                                    {{-- <button class="btn dropdown-item" id="btn-logout">{{ __('Logout') }}</button> --}}
