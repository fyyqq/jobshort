        ...
        <div class="content">
            ...
            <div class="mt-2">
                <div class="box border shadow-sm rounded bg-white mb-3">
                    ...
                    ?>
                    <div class="box-body p-0 {{ $countNotification < 1 ? 'd-flex align-items-center justify-content-center' : '' }}" id="container_notification" style="{{ $countNotification < 1 ? 'height: 400px;' : 'height: max-content;' }}">
