                        ...
                        <div class="mb-4 ps-0 d-flex align-items-center justify-content-start flex-column">
                            ...
                            <div class="d-flex align-items-center justify-content-start w-100 gap-3">
                                <div class="d-flex align-items-start justify-content-center flex-column w-100">
                                    <input type="number" id="delivery_input" class="form-control shadow-none w-10" id="min_delivery" name="min_delivery" value="{{ old('min_delivery', $service->min_delivery) }}" placeholder="Minimum Day">
                                    @error('min_delivery')
                                        <span class="text-start w-100 text-danger" role="alert">
                                            <small class="fw-bold" style="font-size: 12px;">{{ $message }}</small>
                                        </span>
                                ...
                                <div class="d-flex align-items-start justify-content-center flex-column w-100">
                                    <input type="number" id="delivery_input" class="form-control shadow-none w-10" id="max_delivery" name="max_delivery" value="{{ old('max_delivery', $service->max_delivery) }}" placeholder="Maximum Day">
                                    @error('max_delivery')
                                        <span class="text-start w-100 text-danger" role="alert">
                                            <small class="fw-bold" style="font-size: 12px;">{{ $message }}</small>
                                        </span>
