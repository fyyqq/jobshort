...
class RegisterNotification extends Notification
{
    ...
    public function toDatabase(object $notifiable)
    {
        ...
        return [
            ...
            "user" => "admin",
            "image" => "js-logo.jpg",
            "title" => "Welcome to Jobshort!",
            "message" => "We are very happy to have you as a new member of our freelancer community. Jobshort is the perfect place to explore new opportunities, connect with interesting clients, and build an impressive portfolio.
